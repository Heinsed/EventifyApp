                                ...
                                <FilterSectionContainer>
                                    <FilterCheckbox>
                                        <BouncyCheckbox
                                            ...
                                            innerIconStyle={{ borderRadius: 5, borderWidth: 2, borderColor: UIStyles.colors.green }}
                                    ...
                                    <FilterCheckbox>
                                        <BouncyCheckbox
                                            ...
                                            iconStyle={{ borderRadius: 5 }}
                                        />
                                        <CheckboxTitle>Театр</CheckboxTitle>
                                    </FilterCheckbox>
                                    <FilterCheckbox>
                                        <BouncyCheckbox
                                            onPress={(isChecked: false) => {}}
                                            ...
                                            iconStyle={{ borderRadius: 5 }}
                                        />
                                        <CheckboxTitle>Фестиваль</CheckboxTitle>
                                    </FilterCheckbox>
                                    <FilterCheckbox>
                                        <BouncyCheckbox
                                            onPress={(isChecked: false) => {}}
                                            ...
                                            iconStyle={{ borderRadius: 5 }}
                                        />
                                        <CheckboxTitle>Стендап</CheckboxTitle>
                                    </FilterCheckbox>
